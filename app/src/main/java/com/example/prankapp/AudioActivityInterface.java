...
public class AudioActivityInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.audiocallinterface);
        ...
        toolbarTitle.setText("Fake Audio Call");
        ...
        adapter.setOnItemClickListener(new ItemAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(AudioActivityInterface.this, IncomingAudioCall.class);
