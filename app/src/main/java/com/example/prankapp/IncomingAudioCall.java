...
public class IncomingAudioCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.audiocallimcoming);
        ...
        mediaPlayer = MediaPlayer.create(IncomingAudioCall.this, R.raw.audio1);
        mediaPlayer.start();

        answerButton.setOnClickListener(v -> {
            Intent intent = new Intent(IncomingAudioCall.this, AudioAcceptCall.class);
